...
void loop() {
  long start, end;
  start = millis();
  bmpDraw("lily1280.bmp", 0, 0);
  bmpDraw("lily1281.bmp", 0, 0);
  bmpDraw("lily1282.bmp", 0, 0);
  bmpDraw("lily1283.bmp", 0, 0);
  end = millis();
  tft.print(end - start);
  delay(1000);
}
      ...
      if((bmpDepth == 24) && (read32(bmpFile) == 0)) { // 0 = uncompressed
        ...
        for (row=0; row<h; row++) { // For each scanline...
          ...
          for (col=0; col<w; col++) { // For each pixel...
            ...
            pixels[x+col] = tft.Color565(r,g,b);
            //tft.drawPixel(x+col, y+row, tft.Color565(r,g,b));
            //tft.drawPixel(x+col, y+row, pixels[x+col + (y+row)*128]);
            // optimized!
            //tft.pushColor(tft.Color565(r,g,b));
          } // end pixel
          tft.writePixels(x, y, BUFFPIXEL, 1, pixels);
        } // end scanline
